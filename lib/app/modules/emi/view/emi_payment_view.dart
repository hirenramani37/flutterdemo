...
class EMIPaymentView extends StatefulWidget {
  const EMIPaymentView({Key? key}) : super(key: key);

  @override
  _EMIPaymentViewState createState() => _EMIPaymentViewState();
}

class _EMIPaymentViewState extends State<EMIPaymentView> {
